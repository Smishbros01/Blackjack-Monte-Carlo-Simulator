...
![Build Status](https://github.com/Smishbros01/Blackjack-Monte-Carlo-Simulator/actions/workflows/python-app.yml/badge.svg)
...
All parameters are within in `config.json`. You can modify:
